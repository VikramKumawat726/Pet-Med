...
public class SignUpActivity extends AppCompatActivity {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isAllFieldsChecked) {
                    boolean isUserRegistered = myDB.registerUser(usernameSignUp.getText().toString(), emailSignUp.getText().toString(), passwordSignUp.getText().toString());
                    if (isUserRegistered) {
                        Toast.makeText(SignUpActivity.this, "User registered successfully!", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(SignUpActivity.this, LoginActivity.class);
                        startActivity(i);
                    } else {
                        Toast.makeText(SignUpActivity.this, "User with this email or username already exists!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public void onBackPressed() {
        ...
        startActivity(i);
        finish(); // to prevent going back to the previous activity
    }
}