...
public class ManagePetProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!isValidAge(Age)) {
                    Toast.makeText(ManagePetProfile.this, "Please enter a valid age for the pet.", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!isValidHeight(Height)) {
                    Toast.makeText(ManagePetProfile.this, "Please enter a valid height for the pet.", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!isValidWeight(Weight)) {
                    Toast.makeText(ManagePetProfile.this, "Please enter a valid weight for the pet.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private boolean isValidAge(String age) {
        try {
            ...
            return parsedAge > 0 && parsedAge < 20;
    ...
    private boolean isValidHeight(String height) {
        try {
            Integer parsedHeight = Integer.parseInt(height);
            return parsedHeight > 0 && parsedHeight < 200;
        } catch (NumberFormatException e) {
            return false;
        }
    }
    private boolean isValidWeight(String weight) {
        try {
            ...
            return parsedWeight > 0 && parsedWeight < 100;
        } catch (NumberFormatException e) {
            return false;
        }
    }
